# Setup Solana RPC via ansible

# WORK IN PROGRESS.
Instructions below will be updated once everything is tested & working 

### What is it good for?

The goal of the ansible playbook is to have you caught up on the Solana blockchain within 15 minutes, assuming you have a capable server and your SSH key ready. It formats your ssd/nvme disk, sets up swap, ramdisk (optional), downloads from snapshot and restarts everything. Inspired by https://github.com/Overclock-Validator/autoclock-rpc and https://github.com/rpcpool/solana-rpc-ansible
